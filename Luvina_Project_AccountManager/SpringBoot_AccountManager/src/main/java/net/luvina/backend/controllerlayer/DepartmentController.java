...
import net.luvina.DTO.DepartmentDTO;
import net.luvina.backend.servicelayer.IDepartmentService;
...
public class DepartmentController {
	...
	public ResponseEntity<?> deleteDepartmentById(@PathVariable(name = "id") int id) {
